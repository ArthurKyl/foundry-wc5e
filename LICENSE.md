...
This is **unofficial fan content**. **Warcraft** is a trademark of Blizzard
Entertainment. This module is **not affiliated with, endorsed by, or sponsored
by Blizzard Entertainment**, and no ownership of Warcraft intellectual property
is claimed.
...
- **SRD 5.1** — spells embedded on caster monsters are from the **System
  ...
  **Creative Commons Attribution 4.0 International License (CC-BY-4.0)**
  ...
  material taken from the System Reference Document 5.1 by Wizards of the Coast
  LLC and available at <https://dnd.wizards.com/resources/systems-reference-document>.
...
Because this packages another community's conversion of a third party's IP, if
you fork or publish it, keep this attribution intact, coordinate with the WC5E
project, and do not present it as official Blizzard or Wizards of the Coast
material.
